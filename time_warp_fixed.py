...
© 2025 Time_Warp Development Team"""
    ...
    def _open_font_settings(self, parent_dialog):
        ...
        tk.Label(font_dialog, text="Font Settings", font=("Arial", 16, "bold")).pack(pady=10)
    ...
    def _create_ui(self):
        ...
        tools_menu.add_command(label="⚙️ Font Settings...", command=lambda: self._open_font_settings(None))
