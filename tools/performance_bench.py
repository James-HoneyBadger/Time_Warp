...
class PerformanceResult:
    ...
    def __init__(self, name: str, execution_time: float, memory_delta: float, 
                 operations_count: int, success: bool, error: Optional[str] = None):
        self.name = name
...
class TimeWarpPerformanceBench:
    ...
    def run_performance_test(self, name: str, test_func, operations_count: int = 1):
        ...
        result = PerformanceResult(
            ...
            operations_count, success, error
        )
        ...
        def memory_test():
            ...
            for i in range(100):
                ...
                data_structures.append({
                    'list': filtered_list,
                    'keys': dict_keys[:10],  # Keep only first 10
