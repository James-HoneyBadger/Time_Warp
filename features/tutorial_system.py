...
class TutorialStep:
    ...
    def __init__(self, step_id: str, title: str, description: str, 
                 code_template: str = "", expected_output: str = "",
                 hints: List[str] = None, validation_code: str = ""):
...
class Tutorial:
    ...
    def __init__(self, tutorial_id: str, title: str, language: str, 
...
class TutorialSystem:
    ...
    def create_pilot_tutorials(self):
        ...
        pilot_basics = Tutorial(
            "pilot_basics", "PILOT Basics: Your First Steps", "pilot", 
            "beginner", "Learn the fundamentals of PILOT programming language"
        )
        pilot_basics.estimated_time = 30
        
        # Step 1: Hello World
        step1 = TutorialStep(
            "pilot_hello", "Your First PILOT Program",
...
Your task: Write a program that displays 'Hello, TimeWarp!' to the screen.""",
        ...
        # Step 2: Variables
        step2 = TutorialStep(
            "pilot_variables", "Working with Variables",
...
Your task: Create a variable called 'NAME' with your name, then display a greeting.""",
        ...
        step3 = TutorialStep(
            "pilot_math", "Mathematical Calculations",
...
Your task: Calculate the area of a rectangle with width 5 and height 8.""",
    ...
    def create_basic_tutorials(self):
        ...
        basic_fundamentals = Tutorial(
            "basic_fundamentals", "BASIC Programming Fundamentals", "basic",
            "beginner", "Learn classic BASIC programming with line numbers"
        )
        basic_fundamentals.estimated_time = 45
        
        # Step 1: Line Numbers and PRINT
        step1 = TutorialStep(
            "basic_hello", "BASIC Hello World",
...
Your task: Write a BASIC program that prints 'Welcome to BASIC!'""",
        ...
        step2 = TutorialStep(
            "basic_variables", "Variables and LET Statement",
...
Your task: Create a variable for your age and display it.""",
    ...
    def create_logo_tutorials(self):
        ...
        logo_drawing = Tutorial(
            "logo_drawing", "Logo Turtle Graphics", "logo",
            "beginner", "Learn to draw with the Logo turtle"
        )
        logo_drawing.estimated_time = 40
        
        # Step 1: Basic Movement
        step1 = TutorialStep(
            "logo_movement", "Moving the Turtle",
...
Your task: Draw a simple line by moving forward 100 pixels.""",
        ...
        step2 = TutorialStep(
            "logo_square", "Drawing Your First Shape",
...
Your task: Draw a square with sides of 80 pixels.""",
    ...
    def create_python_tutorials(self):
        ...
        python_basics = Tutorial(
            "python_basics", "Python Programming Basics", "python",
            "beginner", "Introduction to Python programming language"
        )
        python_basics.estimated_time = 50
        
        # Step 1: Print and Variables
        step1 = TutorialStep(
            "python_hello", "Python Hello World",
...
Your task: Print a welcome message and use a variable for your name.""",
    ...
    def validate_step(self, user_code: str, output: str) -> Dict[str, Any]:
        ...
        if expected.lower() in actual.lower() or expected == "[Turtle draws a line]" or expected == "[Turtle draws a square]":
            ...
            return {
                ...
                "hint": self.current_step.hints[min(self.current_step.attempts - 1, len(self.current_step.hints) - 1)] if self.current_step.hints else None
            }
